...
namespace esphome {
    namespace opentherm {
        ...
        class OpenThermGWClimate: public climate::Climate, public Component, public api::CustomAPIDevice {
            ...
            binary_sensor::BinarySensor * ch_active {
                nullptr
            };
            binary_sensor::BinarySensor * cooling_active {
                nullptr
            };
            binary_sensor::BinarySensor * dhw_active {
                nullptr
            };
            binary_sensor::BinarySensor * diagnostic_event {
                nullptr
            };
            binary_sensor::BinarySensor * fault_indication {
                nullptr
            };
            binary_sensor::BinarySensor * flame_on {
                nullptr
            };
            sensor::Sensor * control_setpoint {
                nullptr
            };
            sensor::Sensor * boiler_water_temp {
                nullptr
            };
            sensor::Sensor * burner_operation_hours {
                nullptr
            };
            sensor::Sensor * burner_starts {
                nullptr
            };
            sensor::Sensor * ch_pump_operation_hours {
                nullptr
            };
            sensor::Sensor * ch_pump_starts {
                nullptr
            };
            sensor::Sensor * ch_water_pressure {
                nullptr
            };
            sensor::Sensor * dhw2_temperature {
                nullptr
            };
            sensor::Sensor * dhw_burner_operation_hours {
                nullptr
            };
            sensor::Sensor * dhw_burner_starts {
                nullptr
            };
            sensor::Sensor * dhw_flow_rate {
                nullptr
            };
            sensor::Sensor * dhw_pump_valve_operation_hours {
                nullptr
            };
            sensor::Sensor * dhw_pump_valve_starts {
                nullptr
            };
            sensor::Sensor * dhw_temperature {
                nullptr
            };
            sensor::Sensor * exhaust_temperature {
                nullptr
            };
            sensor::Sensor * flow_temperature_ch2 {
                nullptr
            };
            sensor::Sensor * outside_air_temperature {
                nullptr
            };
            sensor::Sensor * relative_modulation_level {
                nullptr
            };
            sensor::Sensor * return_water_temperature {
                nullptr
            };
            sensor::Sensor * solar_collector_temperature {
                nullptr
            };
            sensor::Sensor * solar_storage_temperature {
                nullptr
            };
        };
